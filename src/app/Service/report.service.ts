...
export class ReportService {
  _url='http://127.0.0.1:5000/api/ReportInfo';
  _url_ass = 'http://127.0.0.1:5000/api/Report'
  _sol_url = "http://127.0.0.1:5000/api/solution";
  _rating_url = 'http://127.0.0.1:5000/api/UserRating'; //<int: UserId>/reports/"
  _url_for_tech = 'http://127.0.0.1:5000/api/reports';
