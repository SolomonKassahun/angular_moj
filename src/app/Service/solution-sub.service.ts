...
export class SolutionSubService {
  _url = 'http://127.0.0.1:5000/api/Solution';
  _userInfo = 'http://127.0.0.1:5000/api/LoginInfo';
  _sol_url = 'http://127.0.0.1:5000/api/Solution';
  _rating = 'http://127.0.0.1:5000/api';
  ...
  getRating(reportId: Number): Observable<any>{
    return this._http.get<RatingValue[]>(`${this._rating}/${reportId}/UserRating`)
  }
}
